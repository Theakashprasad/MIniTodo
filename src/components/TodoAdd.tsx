  ...
  return (
    <>
      <div className="flex justify-center mt-10 gap-5">
        ...
        <button
          type="submit"
          className="bg-blue-500   00 focus:ring-2 focus:ring-blue-300 focus:outline-none focus:ring-opacity-50 active:bg-blue-600 text-white font-semibold p-3 rounded-r-full border border-black shadow-md transition duration-150 ease-in-out transform hover:scale-105"
